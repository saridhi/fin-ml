...
sys.path.append('T:\\OASIS_Library\\Sarin')
sys.path.append('T:\\OASIS_Library')
...
class TechSeries(TechLib):
        ...
        _reg_clsid_ = "{3BC23CEF-E3BB-4AC2-BCD8-A6B9C25DACE6}" # Created from pythoncom.CreateGuid()
        _reg_desc_ = "Python TechSeries"
        _reg_progid_ = "Python.TechSeries"
